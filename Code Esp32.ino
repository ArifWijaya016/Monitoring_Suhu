...
void loop() {
  ...
  if (elapsedOutput >= intervalOutput) {
    //LCD
  lcd.setCursor(10, 0);            //Karakter dimulai pada baris 1 kolom 5
  lcd.print(rtc.getDateStr());    //Menampilkan data Tanggal
  lcd.setCursor(0, 0);            //Karakter dimulai pada baris 2 kolom 5
  lcd.print(rtc.getTimeStr());    //Memunculkan data waktu    
